<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="CreateAttendee.aspx.cs" Inherits="AwsWebApp1.CreateAttendee" %>
    ...
    ErrorMessage="Please enter valid email address. Eg. Something@domain.com"></asp:RegularExpressionValidator>
               ...
               <div class="row">
                         <div class="col-xs-2 col-sm-2 col-md-2"></div>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group" style="text-align:left;">
                                   <asp:FileUpload runat="server" id="file" class="form-control input-sm" type="text" placeholder="">
                                       </asp:FileUpload>
                                </div>
                            </div>
                     <div class="col-xs-2 col-sm-2 col-md-2"></div>
